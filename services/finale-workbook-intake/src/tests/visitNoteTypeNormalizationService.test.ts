...
describe("visit note type normalization", () => {
  ...
  it("normalizes visit note statuses used by the portal table", () => {
    ...
    expect(normalizeVisitNoteStatus("Not Started (0/1) e-Signed Participants")).toBe("not_started");
    expect(normalizeVisitNoteStatus("Not Started (0/1) e-Signed Participants Missed Visit")).toBe("missed_visit");
